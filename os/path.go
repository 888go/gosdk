...
const (
	PathSeparator     = os.PathSeparator//qm:常量_系统_路径分隔符  cz:PathSeparator = os.PathSeparator       // 操作系统特定的路径分隔符
	PathListSeparator = os.PathListSeparator//qm:常量_系统_路径列表分隔符  cz:PathSeparator = os.PathSeparator   // 操作系统特定的路径列表分隔符
