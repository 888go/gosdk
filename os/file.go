...
var (
	Stdin  = NewFile(uintptr(syscall.Stdin), "/dev/stdin") //qm:常量_标准输入 cz:Stdin  = NewFile(uintptr(syscall.Stdin), "/dev/stdin")     
	Stdout = NewFile(uintptr(syscall.Stdout), "/dev/stdout") //qm:常量_标准输出 cz:Stdout = NewFile(uintptr(syscall.Stdout), "/dev/stdout")     
	Stderr = NewFile(uintptr(syscall.Stderr), "/dev/stderr") //qm:常量_标准错误 cz:Stderr = NewFile(uintptr(syscall.Stderr), "/dev/stderr")     
)
