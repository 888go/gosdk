...
var (
	...
	ErrInvalid          = os.ErrInvalid//qm:常量_错误_无效参数  cz:ErrInvalid = os.ErrInvalid            // "invalid argument"
	ErrPermission       = os.ErrPermission//qm:常量_错误_权限拒绝  cz:ErrPermission = os.ErrPermission         // "permission denied"
	ErrExist            = os.ErrExist//qm:常量_错误_文件已存在  cz:ErrExist = os.ErrExist              // "file already exists"
	ErrNotExist         = os.ErrNotExist//qm:常量_错误_文件不存在  cz:ErrNotExist = os.ErrNotExist           // "file does not exist"
	ErrClosed           = os.ErrClosed//qm:常量_错误_文件已关闭  cz:ErrClosed = os.ErrClosed             // "file already closed"
	ErrNoDeadline       = os.ErrNoDeadline//qm:常量_错误_文件类型不支持超时截止  cz:ErrNoDeadline = os.ErrNoDeadline         // "文件类型不支持超时截止"
	ErrDeadlineExceeded = os.ErrDeadlineExceeded//qm:常量_错误_IO超时  cz:ErrDeadlineExceeded = os.ErrDeadlineExceeded   // "I/O超时"
) // md5:4e81b490dfa0dc3f
...
type SyscallError struct {//hm:调用错误结构  cz:type SyscallError   //md5:629fa3dd95978e22325ca4574ef483c6
	F os.SyscallError
}
