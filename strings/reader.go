...
//
//	翻译提示:type 读取器 struct {
//	    字符串读取器 strings.Reader
//	}
...
// 翻译提示:func (r *阅读器) 读取(b []字节) (读取长度 int, 错误 error) {}
