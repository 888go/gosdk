...
// }
// [结束]
type Ticker struct { //hm:定时器结构 cz:type Ticker   
	F time.Ticker
...
// md5:8d80705ea00f018e创建定时器时长
// [提示:] func 创建计时器(d 时长) *计时器 {}创建定时器时长
// ff:创建定时器
// d:时长
...
// md5:cc38de911b220071重置时长间隔时长
// [提示:] func (t *计时器) 重置(间隔 Duration) {}重置时长间隔时长
// ff:重置时长
// d:间隔时长
