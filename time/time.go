...
const (
	January   Month = 1//qm:常量_月份_一月  zz:January.*= 1  
	February  Month = 2//qm:常量_月份_二月  zz:February.*= 2  
	March     Month = 3//qm:常量_月份_三月  zz:March.*= 3  
	April     Month = 4//qm:常量_月份_四月  zz:April.*= 4  
	May       Month = 5//qm:常量_月份_五月  zz:May.*= 5  
	June      Month = 6//qm:常量_月份_六月  zz:June.*= 6  
	July      Month = 7//qm:常量_月份_七月  zz:July.*= 7  
	August    Month = 8//qm:常量_月份_八月  zz:August.*= 8  
	September Month = 9//qm:常量_月份_九月  zz:September.*= 9  
	October   Month = 10//qm:常量_月份_十月  zz:October.*= 10  
	November  Month = 11//qm:常量_月份_十一月  zz:November.*= 11  
	December  Month = 12//qm:常量_月份_十二月  zz:December.*= 12  
...
const (
	Nanosecond  Duration = 1//qm:常量_时长_纳秒  zz:Nanosecond.*= 1  
