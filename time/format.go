...
// md5:0e6869ec07aa8837格式化
// [提示:] func (t 时间) 格式化(layout 字符串) 字符串 {}格式化
// ff:格式化
// layout:常量_时间格式_
...
// md5:070a0e7c5343b175格式化并加到字节集
// [提示:] func (t 时间) 添加格式化(b []字节, 格式字符串) []字节 {}格式化并加到字节集
// ff:格式化并加到字节集
// b:字节集
// layout:常量_时间格式_
...
// Error 返回一个 ParseError 的字符串表示。. md5:c5730859166f42e5取错误文本
// [提示:] func (e *解析错误) 错误() 字符串 {}取错误文本
// ff:取错误文本
...
// md5:af59c84e115e04f1解析文本
// [提示:] func 解析布局(layout 字符串, value 字符串) (时间, 错误) {}解析文本
// ff:解析文本
// layout:常量_时间格式_
// value:文本
// Time:
...
// md5:23556e86126104cc解析文本并按时区
// [提示:] func 解析在时区(layout, 值 string, 时区 *地理位置) (时间 Time, 错误 error) {}解析文本并按时区
// ff:解析文本并按时区
// layout:常量_时间格式_
// value:文本
// loc:常量_时区_
...
// Valid time units are "ns", "us" (or "µs"), "ms", "s", "m", "h".解析文本时长
// [提示:] func 解析持续时间(s 字符串) (持续时间, 错误) {}解析文本时长
// ff:解析文本时长
// s:文本
// Duration:
