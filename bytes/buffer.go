...
// 翻译提示:const  最小读取量  =  512  //md5:e6440ccdc461dcd6
...
// 翻译提示:var  错误过大  =  bytes.错误过大  //md5:5fb25188c1ad1858
...
// 翻译提示:func  (b  *缓冲区)  写入(p  []字节)  (写入数  int,  错误  error)  {}
...
// 翻译提示:func  (b  *缓冲区)  写入字符串(s  字符串)  (写入长度  int,  错误  error)  {}
...
// 翻译提示:func  (b  *缓冲区)  从读取(r  io读取器)  (读取量  int64,  错误  error)  {}
...
// 翻译提示:func  (b  *缓冲区)  写入到(w  io.Writer)  (写入字节数  int64,  错误  error)  {}
...
// 翻译提示:func  (b  *缓冲区)  写入字符(r  rune)  (长度  int,  错误  error)  {}
...
// 翻译提示:func  (b  *缓冲区)  读取(p  []字节)  (读取长度  int,  错误  error)  {}
...
// 翻译提示:func  (b  *缓冲区)  读取Unicode字符()(字符  rune,  大小  int,  错误  error)  {}
...
// 翻译提示:func  (b  *缓冲区)  读取到分隔符(delim  字节)  (行  []字节,  错误  error)  {}
...
// 翻译提示:func  (b  *缓冲区)  读取到分隔符(delim  字节)  (行  string,  错误  error)  {}
