...
// 翻译提示:func  编译正则表达式(expr  字符串)  (*正则表达式,  错误)  {}
...
// 翻译提示:func  编译POSIX正则表达式(expr  字符串)  (*正则表达式,  错误)  {}
...
// 翻译提示:func  必须编译正则表达式(str  字符串)  *正则表达式  {}
...
// 翻译提示:func  必须编译POSIX(str  字符串)  *正则表达式  {}
...
// 翻译提示:func  (re  *正则表达式)  子模式索引(name  字符串)  整数  {}
...
// 翻译提示:func  (re  *正则表达式)  常量前缀()  (前缀  string,  完整  bool)  {}
...
// 翻译提示:func  (re  *Regexp)  匹配读取器(r  io.Runereader)  bool  {}
...
// 翻译提示:func  (re  *正则表达式)  匹配字符串(s  字符串)  bool  {}
...
// 翻译提示:func  (re  *正则表达式)  匹配字节切片(b  []字节)  bool  {}
...
// 翻译提示:func  匹配读取器(pattern  字符串,  reader  音节阅读器)  (匹配成功  bool,  错误  error)  {}
...
// 翻译提示:func  匹配字符串(pattern  字符串,  s  字符串)  (匹配成功  bool,  错误  error)  {}
...
// 翻译提示:func  匹配模式(pattern  字符串,  数据字节切片  []byte)  (匹配结果  bool,  错误  error)  {}
...
// 翻译提示:func  (re  *正则表达式)  替换所有字符串源(src,  替换字符串  repl)  string  {}
...
// 翻译提示:func  (re  *正则表达式)  替换所有字面量字符串源(src  string,  替换字符串  repl  string)  string  {}
...
// 翻译提示:func  (re  *正则表达式)  替换所有字符串函数(src  字符串,  替换函数  func(原始匹配字符串)  字符串)  字符串  {}
...
// 翻译提示:func  (re  *正则表达式)  替换所有源字节(src  []字节,  替换内容  repl  []字节)  []字节  {}
...
// 翻译提示:func  (re  *正则表达式)  替换所有字面量源(src,  替换字符串  []byte)  []byte  {}
...
// 翻译提示:func  (re  *正则表达式)  替换所有字节片(src  []字节,  替换函数  func([]字节)  []字节)  []字节  {}
...
// 翻译提示:func  (re  *正则表达式)  查找索引(b  []字节)  (位置  []整数)  {}
...
// 翻译提示:func  (re  *正则表达式)  查找字符串(s  string)  字符串  {}
...
// 翻译提示:func  (re  *正则表达式)  查找字符串索引(s  字符串)  (位置  []int)  {}
...
// 翻译提示:func  (re  *正则表达式)  查找读取器索引(r  io.字符阅读器)  (位置  []int)  {}
...
// 翻译提示:func  (re  *正则表达式)  查找子匹配(b  []字节)  [][]字节  {}
...
// 翻译提示:func  (re  *正则表达式)  扩展替换(dst  []字节,  模板  []字节,  原始输入  []字节,  匹配结果  []int)  []字节  {}
...
// 翻译提示:func  (re  *正则表达式)  扩展字符串(dst  字节切片,  模板字符串,  原始字符串  string,  匹配结果  []int)  字节切片  {}
...
// 翻译提示:func  (re  *正则表达式)  查找字符串子匹配(s  字符串)  []字符串  {}
...
// 翻译提示:func  (re  *正则表达式)  查找字符串子匹配索引(s  string)  []int  {}
...
// 翻译提示://  在给定的  RuneReader  中查找匹配正则表达式的子匹配索引，并返回它们的开始和结束位置。
// func  (re  *Regexp)  查找Reader子匹配索引(r  io.RuneReader)  []int  {}
...
// 翻译提示:func  (re  *正则表达式)  查找所有匹配(b  []字节,  n  int)  [][]字节  {}
...
// 翻译提示:func  (re  *正则表达式)  查找所有索引(b  []字节,  n  int)  [][]整数  {}
...
// 翻译提示:func  (re  *正则表达式)  查找所有字符串(s  string,  限制次数  n  int)  []string  {}
...
// 翻译提示:func  (re  *正则表达式)  查找所有子匹配索引(b  []字节,  n  int)  [][]int  {}
...
// 翻译提示:func  (re  *正则表达式)  查找所有字符串子匹配索引(s  string,  数量  int)  [][]int  {}
...
// 翻译提示:func  (re  *正则表达式)  分割(s  字符串,  n  int)  []字符串  {}
