...
//2024-05-01  这个文件没有关于正则类的单元测试, 是分析正则表达式的单元测试
//import (
//	"reflect"
//	"regexp/syntax"
//	"strings"
...
//	{`foo`, `foo`, `foo`, true},
//	{`日本語+`, `日本語\+`, `日本語`, false},
//	{`foo\.\$`, `foo\\\.\\\$`, `foo.$`, true}, // 包含元数据但没有操作符. md5:bf7c380f434a98f4
//	{`foo.\$`, `foo\.\\\$`, `foo`, false},     // 包含转义的运算符和真实的运算符. md5:2d82d20a1cf951a1
//	{`!@#$%^&*()_+-=[{]}\|,<.>/?~`, `!@#\$%\^&\*\(\)_\+-=\[\{\]\}\\\|,<\.>/\?~`, `!@#`, false},
//}
//
...
//	re.Match(long)     // 触发标准匹配器. md5:02a663df6450df58
...
//	if !reflect.DeepEqual(re1, re2) { // 自Go 1以来一直为真。. md5:d865a8317f116dbb
